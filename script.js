...
const tracks = [
  { title: 'No track selected', artist: 'wolf.', art: 'https://wolfiinator.github.io/wolf.lol-beta/assets/profile.gif' },
  { title: 'not listening', artist: 'spotify', art: 'https://wolfiinator.github.io/wolf.lol-beta/assets/profile.gif' },
  { title: 'waiting for profile', artist: 'profile', art: 'https://wolfiinator.github.io/wolf.lol-beta/assets/profile.gif' },
];
...
const characters = [
  ...
  {
    name: 'Jack',
    image: 'https://wolfiinator.github.io/wolf.lol-beta/assets/profile.gif',
...
$('#save-comment-profile').addEventListener('click', () => {
  ...
  if (pfp) {
    $('#comment-preview').src = pfp;
    $('#comment-compose-preview').src = pfp;
  }
});
